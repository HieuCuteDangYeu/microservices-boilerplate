...
| `apps/content-service/src/application/use-cases/search-public-reels-prompt4.spec.ts` | Prompt 4 | Disabled-by-default emergency legacy public-search fallback |
| `scripts/tmp/verify-semantic-cutover.cjs` | Prompt 3 | Reports imported legacy semantic documents during the rollback window |
| `scripts/tmp/compare-legacy-indexing-search.cjs` | Prompt 3 | Compares legacy and canonical shared-context search |
| `scripts/tmp/compare-public-semantic-search.cjs` | Prompt 3 | Compares legacy and canonical public search |
