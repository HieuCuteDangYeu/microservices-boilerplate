import { ToolCallingRetrievalAgentAdapter } from './tool-calling-retrieval-agent.adapter';
...
describe('ToolCallingRetrievalAgentAdapter', () => {
  it('executes a model-selected high-level search through the retrieval engine port', async () => {
    ...
    const agent = new ToolCallingRetrievalAgentAdapter(
