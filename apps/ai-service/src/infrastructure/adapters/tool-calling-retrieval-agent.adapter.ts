...
import type { IRetrievalAgent } from '@ai/domain/interfaces/retrieval-agent.interface';
...
@Injectable()
export class ToolCallingRetrievalAgentAdapter implements IRetrievalAgent {
  private readonly toolLogger = new Logger(ToolCallingRetrievalAgentAdapter.name);
