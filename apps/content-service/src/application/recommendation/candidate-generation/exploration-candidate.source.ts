...
@Injectable()
export class ExplorationCandidateSource implements IRecommendationCandidateSource {
  readonly source = 'EXPLORATION' as const;
  ...
  generate(
    ...
    return this.repository.findExplorationCandidates(input);
  }
}
