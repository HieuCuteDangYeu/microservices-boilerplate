...
@Injectable()
export class TrendingCandidateSource implements IRecommendationCandidateSource {
  readonly source = 'TRENDING' as const;
  ...
  generate(
    ...
    return this.repository.findTrendingCandidates(input);
  }
}
