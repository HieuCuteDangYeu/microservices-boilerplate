...
@Injectable()
export class CreatorAffinityCandidateSource implements IRecommendationCandidateSource {
  readonly source = 'CREATOR_AFFINITY' as const;
  ...
  generate(
    ...
    return this.repository.findCreatorAffinityCandidates(input);
  }
}
