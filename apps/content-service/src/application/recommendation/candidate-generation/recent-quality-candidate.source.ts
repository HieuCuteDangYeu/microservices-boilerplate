...
@Injectable()
export class RecentQualityCandidateSource implements IRecommendationCandidateSource {
  readonly source = 'RECENT_QUALITY' as const;
  ...
  generate(
    ...
    return this.repository.findRecentQualityCandidates(input);
  }
}
